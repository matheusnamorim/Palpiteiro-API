...
import { addGuesses, listGames, listGuessByName, listGuesses, rankingOfGuesses, removeGuesses, updateGames } from '../controllers/guesses.controllers.js';
...
router.get('/ranking', rankingOfGuesses);
